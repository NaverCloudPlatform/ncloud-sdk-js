...
(function(root, factory) {
   ...
   * @module com.ncloud.server.model/StopServerInstancesRequest
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>StopServerInstancesRequest</code>.
   * @alias module:com.ncloud.server.model/StopServerInstancesRequest
   * @class
   ...
   * @param {module:com.ncloud.server.model/StopServerInstancesRequest} obj Optional instance to populate.
   * @return {module:com.ncloud.server.model/StopServerInstancesRequest} The populated <code>StopServerInstancesRequest</code> instance.
   */
