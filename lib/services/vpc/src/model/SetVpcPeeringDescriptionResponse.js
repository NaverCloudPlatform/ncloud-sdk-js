...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Vpc.SetVpcPeeringDescriptionResponse = factory(root.Vpc.ApiClient, root.Vpc.VpcPeeringInstance);
  }
  ...
  /**
   * The SetVpcPeeringDescriptionResponse model module.
   * @module model/SetVpcPeeringDescriptionResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>SetVpcPeeringDescriptionResponse</code>.
   * @alias module:model/SetVpcPeeringDescriptionResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>SetVpcPeeringDescriptionResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SetVpcPeeringDescriptionResponse} obj Optional instance to populate.
   * @return {module:model/SetVpcPeeringDescriptionResponse} The populated <code>SetVpcPeeringDescriptionResponse</code> instance.
   */
