...
(function(root, factory) {
   ...
   * @module model/GetCloudDBImageProductListResponse
   * @version 1.4.1
   */

  /**
   * Constructs a new <code>GetCloudDBImageProductListResponse</code>.
   * @alias module:model/GetCloudDBImageProductListResponse
   * @class
   */
   ...
   * @param {module:model/GetCloudDBImageProductListResponse} obj Optional instance to populate.
   * @return {module:model/GetCloudDBImageProductListResponse} The populated <code>GetCloudDBImageProductListResponse</code> instance.
   */
