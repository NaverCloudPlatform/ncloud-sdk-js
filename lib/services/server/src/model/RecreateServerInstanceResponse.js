...
(function(root, factory) {
   ...
   * @module model/RecreateServerInstanceResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>RecreateServerInstanceResponse</code>.
   * @alias module:model/RecreateServerInstanceResponse
   * @class
   */
   ...
   * @param {module:model/RecreateServerInstanceResponse} obj Optional instance to populate.
   * @return {module:model/RecreateServerInstanceResponse} The populated <code>RecreateServerInstanceResponse</code> instance.
   */
