...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Vserver.AddNetworkInterfaceAccessControlGroupResponse = factory(root.Vserver.ApiClient, root.Vserver.NetworkInterface);
  }
  ...
  /**
   * The AddNetworkInterfaceAccessControlGroupResponse model module.
   * @module model/AddNetworkInterfaceAccessControlGroupResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>AddNetworkInterfaceAccessControlGroupResponse</code>.
   * @alias module:model/AddNetworkInterfaceAccessControlGroupResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>AddNetworkInterfaceAccessControlGroupResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AddNetworkInterfaceAccessControlGroupResponse} obj Optional instance to populate.
   * @return {module:model/AddNetworkInterfaceAccessControlGroupResponse} The populated <code>AddNetworkInterfaceAccessControlGroupResponse</code> instance.
   */
