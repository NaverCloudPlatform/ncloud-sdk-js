...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Vserver.CreateBlockStorageSnapshotInstanceResponse = factory(root.Vserver.ApiClient, root.Vserver.BlockStorageSnapshotInstance);
  }
  ...
  /**
   * The CreateBlockStorageSnapshotInstanceResponse model module.
   * @module model/CreateBlockStorageSnapshotInstanceResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CreateBlockStorageSnapshotInstanceResponse</code>.
   * @alias module:model/CreateBlockStorageSnapshotInstanceResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>CreateBlockStorageSnapshotInstanceResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateBlockStorageSnapshotInstanceResponse} obj Optional instance to populate.
   * @return {module:model/CreateBlockStorageSnapshotInstanceResponse} The populated <code>CreateBlockStorageSnapshotInstanceResponse</code> instance.
   */
