...
(function(root, factory) {
   ...
   * @module model/GetCloudDBProductListResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GetCloudDBProductListResponse</code>.
   * @alias module:model/GetCloudDBProductListResponse
   * @class
   */
   ...
   * @param {module:model/GetCloudDBProductListResponse} obj Optional instance to populate.
   * @return {module:model/GetCloudDBProductListResponse} The populated <code>GetCloudDBProductListResponse</code> instance.
   */
