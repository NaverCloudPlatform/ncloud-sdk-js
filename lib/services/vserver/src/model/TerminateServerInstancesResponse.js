...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Vserver.TerminateServerInstancesResponse = factory(root.Vserver.ApiClient, root.Vserver.ServerInstance);
  }
   ...
   * @module model/TerminateServerInstancesResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>TerminateServerInstancesResponse</code>.
   * @alias module:model/TerminateServerInstancesResponse
   * @class
   */
   ...
   * @param {module:model/TerminateServerInstancesResponse} obj Optional instance to populate.
   * @return {module:model/TerminateServerInstancesResponse} The populated <code>TerminateServerInstancesResponse</code> instance.
   */
