...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Vpc.DeleteVpcPeeringInstanceResponse = factory(root.Vpc.ApiClient, root.Vpc.VpcPeeringInstance);
  }
  ...
  /**
   * The DeleteVpcPeeringInstanceResponse model module.
   * @module model/DeleteVpcPeeringInstanceResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DeleteVpcPeeringInstanceResponse</code>.
   * @alias module:model/DeleteVpcPeeringInstanceResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>DeleteVpcPeeringInstanceResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DeleteVpcPeeringInstanceResponse} obj Optional instance to populate.
   * @return {module:model/DeleteVpcPeeringInstanceResponse} The populated <code>DeleteVpcPeeringInstanceResponse</code> instance.
   */
