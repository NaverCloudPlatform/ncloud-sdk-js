...
(function(root, factory) {
   ...
   * @module model/ChangeLoadBalancedServerInstancesResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ChangeLoadBalancedServerInstancesResponse</code>.
   * @alias module:model/ChangeLoadBalancedServerInstancesResponse
   * @class
   */
   ...
   * @param {module:model/ChangeLoadBalancedServerInstancesResponse} obj Optional instance to populate.
   * @return {module:model/ChangeLoadBalancedServerInstancesResponse} The populated <code>ChangeLoadBalancedServerInstancesResponse</code> instance.
   */
