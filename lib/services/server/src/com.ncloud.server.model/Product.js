...
(function(root, factory) {
   ...
   * @module com.ncloud.server.model/Product
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>Product</code>.
   * @alias module:com.ncloud.server.model/Product
   * @class
   */
   ...
   * @param {module:com.ncloud.server.model/Product} obj Optional instance to populate.
   * @return {module:com.ncloud.server.model/Product} The populated <code>Product</code> instance.
   */
  ...
  /**
   * 상품유형
   * @member {module:com.ncloud.server.model/CommonCode} productType
   */
  ...
  /**
   * 인프라자원구분
   * @member {module:com.ncloud.server.model/CommonCode} infraResourceType
   */
  exports.prototype['infraResourceType'] = undefined;
  /**
   * 인프라자원상세구분
   * @member {module:com.ncloud.server.model/CommonCode} infraResourceDetailType
   */
