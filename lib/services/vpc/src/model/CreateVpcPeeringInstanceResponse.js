...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Vpc.CreateVpcPeeringInstanceResponse = factory(root.Vpc.ApiClient, root.Vpc.VpcPeeringInstance);
  }
  ...
  /**
   * The CreateVpcPeeringInstanceResponse model module.
   * @module model/CreateVpcPeeringInstanceResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>CreateVpcPeeringInstanceResponse</code>.
   * @alias module:model/CreateVpcPeeringInstanceResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>CreateVpcPeeringInstanceResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateVpcPeeringInstanceResponse} obj Optional instance to populate.
   * @return {module:model/CreateVpcPeeringInstanceResponse} The populated <code>CreateVpcPeeringInstanceResponse</code> instance.
   */
