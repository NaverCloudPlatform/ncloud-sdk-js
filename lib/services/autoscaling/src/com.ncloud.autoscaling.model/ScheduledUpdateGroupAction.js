...
(function(root, factory) {
   ...
   * @module com.ncloud.autoscaling.model/ScheduledUpdateGroupAction
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ScheduledUpdateGroupAction</code>.
   * @alias module:com.ncloud.autoscaling.model/ScheduledUpdateGroupAction
   * @class
   */
   ...
   * @param {module:com.ncloud.autoscaling.model/ScheduledUpdateGroupAction} obj Optional instance to populate.
   * @return {module:com.ncloud.autoscaling.model/ScheduledUpdateGroupAction} The populated <code>ScheduledUpdateGroupAction</code> instance.
   */
