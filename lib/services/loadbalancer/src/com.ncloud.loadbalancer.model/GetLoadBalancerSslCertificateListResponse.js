...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Loadbalancer.GetLoadBalancerSslCertificateListResponse = factory(root.Loadbalancer.ApiClient, root.Loadbalancer.SslCertificate);
  }
  ...
  /**
   * The GetLoadBalancerSslCertificateListResponse model module.
   * @module com.ncloud.loadbalancer.model/GetLoadBalancerSslCertificateListResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GetLoadBalancerSslCertificateListResponse</code>.
   * @alias module:com.ncloud.loadbalancer.model/GetLoadBalancerSslCertificateListResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>GetLoadBalancerSslCertificateListResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:com.ncloud.loadbalancer.model/GetLoadBalancerSslCertificateListResponse} obj Optional instance to populate.
   * @return {module:com.ncloud.loadbalancer.model/GetLoadBalancerSslCertificateListResponse} The populated <code>GetLoadBalancerSslCertificateListResponse</code> instance.
   */
