...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Clouddb.Product = factory(root.Clouddb.ApiClient, root.Clouddb.CommonCode);
  }
   ...
   * @module com.ncloud.clouddb.model/Product
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>Product</code>.
   * @alias module:com.ncloud.clouddb.model/Product
   * @class
   */
   ...
   * @param {module:com.ncloud.clouddb.model/Product} obj Optional instance to populate.
   * @return {module:com.ncloud.clouddb.model/Product} The populated <code>Product</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('addBlockStroageSize')) {
        obj['addBlockStroageSize'] = ApiClient.convertToType(data['addBlockStroageSize'], 'Number');
      }
    }
    return obj;
  }
  ...
  /**
   * 상품유형
   * @member {module:com.ncloud.clouddb.model/CommonCode} productType
   */
  ...
  /**
   * 인프라자원구분
   * @member {module:com.ncloud.clouddb.model/CommonCode} infraResourceType
   */
  ...
  /**
   * 플랫폼구분
   * @member {module:com.ncloud.clouddb.model/CommonCode} platformType
   */
  ...
  /**
   * 디스크유형
   * @member {module:com.ncloud.clouddb.model/CommonCode} diskType
   */
  ...
  /**
   * 추가블록스토리지사이즈
   * @member {Number} addBlockStroageSize
   */
  exports.prototype['addBlockStroageSize'] = undefined;
