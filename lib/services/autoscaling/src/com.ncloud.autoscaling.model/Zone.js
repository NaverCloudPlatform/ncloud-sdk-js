...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Autoscaling.Zone = factory(root.Autoscaling.ApiClient);
  }
   ...
   * @module com.ncloud.autoscaling.model/Zone
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>Zone</code>.
   * @alias module:com.ncloud.autoscaling.model/Zone
   * @class
   */
   ...
   * @param {module:com.ncloud.autoscaling.model/Zone} obj Optional instance to populate.
   * @return {module:com.ncloud.autoscaling.model/Zone} The populated <code>Zone</code> instance.
   */
