...
(function(root, factory) {
   ...
   * @module com.ncloud.cdn.model/CdnPlusServiceDomain
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CdnPlusServiceDomain</code>.
   * @alias module:com.ncloud.cdn.model/CdnPlusServiceDomain
   * @class
   */
   ...
   * @param {module:com.ncloud.cdn.model/CdnPlusServiceDomain} obj Optional instance to populate.
   * @return {module:com.ncloud.cdn.model/CdnPlusServiceDomain} The populated <code>CdnPlusServiceDomain</code> instance.
   */
