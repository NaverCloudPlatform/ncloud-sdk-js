...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'com.ncloud.autoscaling.model/ScalingPolicy'], factory);
   ...
   * @module com.ncloud.autoscaling.model/GetAutoScalingPolicyListResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GetAutoScalingPolicyListResponse</code>.
   * @alias module:com.ncloud.autoscaling.model/GetAutoScalingPolicyListResponse
   * @class
   */
   ...
   * @param {module:com.ncloud.autoscaling.model/GetAutoScalingPolicyListResponse} obj Optional instance to populate.
   * @return {module:com.ncloud.autoscaling.model/GetAutoScalingPolicyListResponse} The populated <code>GetAutoScalingPolicyListResponse</code> instance.
   */
  ...
  /**
   * @member {Array.<module:com.ncloud.autoscaling.model/ScalingPolicy>} scalingPolicyList
   */
