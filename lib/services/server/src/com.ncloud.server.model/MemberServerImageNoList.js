...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Server.MemberServerImageNoList = factory(root.Server.ApiClient);
  }
  ...
  /**
   * The MemberServerImageNoList model module.
   * @module com.ncloud.server.model/MemberServerImageNoList
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>MemberServerImageNoList</code>.
   * @alias module:com.ncloud.server.model/MemberServerImageNoList
   * @class
  ...
  /**
   * Constructs a <code>MemberServerImageNoList</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:com.ncloud.server.model/MemberServerImageNoList} obj Optional instance to populate.
   * @return {module:com.ncloud.server.model/MemberServerImageNoList} The populated <code>MemberServerImageNoList</code> instance.
   */
