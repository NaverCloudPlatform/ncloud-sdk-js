...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Server.StartServerInstancesResponse = factory(root.Server.ApiClient, root.Server.ServerInstance);
  }
  ...
  /**
   * The StartServerInstancesResponse model module.
   * @module com.ncloud.server.model/StartServerInstancesResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>StartServerInstancesResponse</code>.
   * @alias module:com.ncloud.server.model/StartServerInstancesResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>StartServerInstancesResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:com.ncloud.server.model/StartServerInstancesResponse} obj Optional instance to populate.
   * @return {module:com.ncloud.server.model/StartServerInstancesResponse} The populated <code>StartServerInstancesResponse</code> instance.
   */
