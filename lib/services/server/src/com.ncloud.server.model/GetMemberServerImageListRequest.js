...
(function(root, factory) {
   ...
   * @module com.ncloud.server.model/GetMemberServerImageListRequest
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GetMemberServerImageListRequest</code>.
   * @alias module:com.ncloud.server.model/GetMemberServerImageListRequest
   * @class
   */
   ...
   * @param {module:com.ncloud.server.model/GetMemberServerImageListRequest} obj Optional instance to populate.
   * @return {module:com.ncloud.server.model/GetMemberServerImageListRequest} The populated <code>GetMemberServerImageListRequest</code> instance.
   */
