...
(function(root, factory) {
   ...
   * @module com.ncloud.server.model/ChangeServerInstanceSpecRequest
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ChangeServerInstanceSpecRequest</code>.
   * @alias module:com.ncloud.server.model/ChangeServerInstanceSpecRequest
   * @class
   ...
   * @param {module:com.ncloud.server.model/ChangeServerInstanceSpecRequest} obj Optional instance to populate.
   * @return {module:com.ncloud.server.model/ChangeServerInstanceSpecRequest} The populated <code>ChangeServerInstanceSpecRequest</code> instance.
   */
