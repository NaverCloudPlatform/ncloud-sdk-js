...
(function(root, factory) {
   ...
   * @module com.ncloud.server.model/AssociatePublicIpWithServerInstanceRequest
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>AssociatePublicIpWithServerInstanceRequest</code>.
   * @alias module:com.ncloud.server.model/AssociatePublicIpWithServerInstanceRequest
   * @class
   ...
   * @param {module:com.ncloud.server.model/AssociatePublicIpWithServerInstanceRequest} obj Optional instance to populate.
   * @return {module:com.ncloud.server.model/AssociatePublicIpWithServerInstanceRequest} The populated <code>AssociatePublicIpWithServerInstanceRequest</code> instance.
   */
