...
(function(root, factory) {
   ...
   * @module model/PutScheduledUpdateGroupActionRequest
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PutScheduledUpdateGroupActionRequest</code>.
   * @alias module:model/PutScheduledUpdateGroupActionRequest
   * @class
   ...
   * @param {module:model/PutScheduledUpdateGroupActionRequest} obj Optional instance to populate.
   * @return {module:model/PutScheduledUpdateGroupActionRequest} The populated <code>PutScheduledUpdateGroupActionRequest</code> instance.
   */
