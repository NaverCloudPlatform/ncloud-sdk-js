...
(function(root, factory) {
   ...
   * @module com.ncloud.loadbalancer.model/ChangeLoadBalancerInstanceConfigurationResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ChangeLoadBalancerInstanceConfigurationResponse</code>.
   * @alias module:com.ncloud.loadbalancer.model/ChangeLoadBalancerInstanceConfigurationResponse
   * @class
   */
   ...
   * @param {module:com.ncloud.loadbalancer.model/ChangeLoadBalancerInstanceConfigurationResponse} obj Optional instance to populate.
   * @return {module:com.ncloud.loadbalancer.model/ChangeLoadBalancerInstanceConfigurationResponse} The populated <code>ChangeLoadBalancerInstanceConfigurationResponse</code> instance.
   */
