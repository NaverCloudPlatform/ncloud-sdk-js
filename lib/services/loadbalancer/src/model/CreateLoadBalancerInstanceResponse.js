...
(function(root, factory) {
   ...
   * @module model/CreateLoadBalancerInstanceResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CreateLoadBalancerInstanceResponse</code>.
   * @alias module:model/CreateLoadBalancerInstanceResponse
   * @class
   */
   ...
   * @param {module:model/CreateLoadBalancerInstanceResponse} obj Optional instance to populate.
   * @return {module:model/CreateLoadBalancerInstanceResponse} The populated <code>CreateLoadBalancerInstanceResponse</code> instance.
   */
