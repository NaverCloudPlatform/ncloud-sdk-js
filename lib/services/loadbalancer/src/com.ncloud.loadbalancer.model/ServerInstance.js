...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'com.ncloud.loadbalancer.model/AccessControlGroup', 'com.ncloud.loadbalancer.model/CommonCode', 'com.ncloud.loadbalancer.model/Region', 'com.ncloud.loadbalancer.model/Zone'], factory);
    ...
    root.Loadbalancer.ServerInstance = factory(root.Loadbalancer.ApiClient, root.Loadbalancer.AccessControlGroup, root.Loadbalancer.CommonCode, root.Loadbalancer.Region, root.Loadbalancer.Zone);
  }
   ...
   * @module com.ncloud.loadbalancer.model/ServerInstance
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ServerInstance</code>.
   * @alias module:com.ncloud.loadbalancer.model/ServerInstance
   * @class
   */
   ...
   * @param {module:com.ncloud.loadbalancer.model/ServerInstance} obj Optional instance to populate.
   * @return {module:com.ncloud.loadbalancer.model/ServerInstance} The populated <code>ServerInstance</code> instance.
   */
  ...
  /**
   * 플랫폼구분
   * @member {module:com.ncloud.loadbalancer.model/CommonCode} platformType
   */
  ...
  /**
   * 서버인스턴스상태
   * @member {module:com.ncloud.loadbalancer.model/CommonCode} serverInstanceStatus
   */
  exports.prototype['serverInstanceStatus'] = undefined;
  /**
   * 서버인스턴스OP
   * @member {module:com.ncloud.loadbalancer.model/CommonCode} serverInstanceOperation
   */
  ...
  /**
   * Zone
   * @member {module:com.ncloud.loadbalancer.model/Zone} zone
   */
  exports.prototype['zone'] = undefined;
  /**
   * 리전
   * @member {module:com.ncloud.loadbalancer.model/Region} region
   */
  exports.prototype['region'] = undefined;
  /**
   * 기본블록스토리지디스크유형
   * @member {module:com.ncloud.loadbalancer.model/CommonCode} baseBlockStorageDiskType
   */
  exports.prototype['baseBlockStorageDiskType'] = undefined;
  /**
   * 기본블록스토리지디스크상세유형
   * @member {module:com.ncloud.loadbalancer.model/CommonCode} baseBlockStroageDiskDetailType
   */
  exports.prototype['baseBlockStroageDiskDetailType'] = undefined;
  /**
   * 인터넷라인구분
   * @member {module:com.ncloud.loadbalancer.model/CommonCode} internetLineType
   */
  ...
  /**
   * ACG리스트
   * @member {Array.<module:com.ncloud.loadbalancer.model/AccessControlGroup>} accessControlGroupList
   */
