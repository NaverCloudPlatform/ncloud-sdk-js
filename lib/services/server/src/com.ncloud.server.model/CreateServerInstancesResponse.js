...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Server.CreateServerInstancesResponse = factory(root.Server.ApiClient, root.Server.ServerInstance);
  }
  ...
  /**
   * The CreateServerInstancesResponse model module.
   * @module com.ncloud.server.model/CreateServerInstancesResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CreateServerInstancesResponse</code>.
   * @alias module:com.ncloud.server.model/CreateServerInstancesResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>CreateServerInstancesResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:com.ncloud.server.model/CreateServerInstancesResponse} obj Optional instance to populate.
   * @return {module:com.ncloud.server.model/CreateServerInstancesResponse} The populated <code>CreateServerInstancesResponse</code> instance.
   */
