...
(function(root, factory) {
   ...
   * @module com.ncloud.server.model/GetServerProductListResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GetServerProductListResponse</code>.
   * @alias module:com.ncloud.server.model/GetServerProductListResponse
   * @class
   */
   ...
   * @param {module:com.ncloud.server.model/GetServerProductListResponse} obj Optional instance to populate.
   * @return {module:com.ncloud.server.model/GetServerProductListResponse} The populated <code>GetServerProductListResponse</code> instance.
   */
