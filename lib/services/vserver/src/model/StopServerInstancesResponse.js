...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Vserver.StopServerInstancesResponse = factory(root.Vserver.ApiClient, root.Vserver.ServerInstance);
  }
   ...
   * @module model/StopServerInstancesResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>StopServerInstancesResponse</code>.
   * @alias module:model/StopServerInstancesResponse
   * @class
   */
   ...
   * @param {module:model/StopServerInstancesResponse} obj Optional instance to populate.
   * @return {module:model/StopServerInstancesResponse} The populated <code>StopServerInstancesResponse</code> instance.
   */
