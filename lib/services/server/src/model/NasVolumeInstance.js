...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CommonCode', 'model/NasVolumeInstanceCustomIp', 'model/Region', 'model/ServerInstance', 'model/Zone'], factory);
  ...
  /**
   * NAS볼륨커스텀IP리스트
   * @member {Array.<module:model/NasVolumeInstanceCustomIp>} nasVolumeInstanceCustomIpList
   */
  exports.prototype['nasVolumeInstanceCustomIpList'] = undefined;
  /**
   * NAS볼륨서버인스턴스리스트
   * @member {Array.<module:model/ServerInstance>} nasVolumeServerInstanceList
   */
