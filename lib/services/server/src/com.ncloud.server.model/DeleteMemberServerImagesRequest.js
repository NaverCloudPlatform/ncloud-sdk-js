...
(function(root, factory) {
   ...
   * @module com.ncloud.server.model/DeleteMemberServerImagesRequest
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DeleteMemberServerImagesRequest</code>.
   * @alias module:com.ncloud.server.model/DeleteMemberServerImagesRequest
   * @class
   ...
   * @param {module:com.ncloud.server.model/DeleteMemberServerImagesRequest} obj Optional instance to populate.
   * @return {module:com.ncloud.server.model/DeleteMemberServerImagesRequest} The populated <code>DeleteMemberServerImagesRequest</code> instance.
   */
