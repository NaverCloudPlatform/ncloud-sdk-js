...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Vserver.GetInitScriptDetailResponse = factory(root.Vserver.ApiClient, root.Vserver.InitScript);
  }
  ...
  /**
   * The GetInitScriptDetailResponse model module.
   * @module model/GetInitScriptDetailResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GetInitScriptDetailResponse</code>.
   * @alias module:model/GetInitScriptDetailResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>GetInitScriptDetailResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetInitScriptDetailResponse} obj Optional instance to populate.
   * @return {module:model/GetInitScriptDetailResponse} The populated <code>GetInitScriptDetailResponse</code> instance.
   */
