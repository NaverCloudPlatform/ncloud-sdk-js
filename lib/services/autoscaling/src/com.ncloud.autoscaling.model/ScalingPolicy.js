...
(function(root, factory) {
   ...
   * @module com.ncloud.autoscaling.model/ScalingPolicy
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ScalingPolicy</code>.
   * @alias module:com.ncloud.autoscaling.model/ScalingPolicy
   * @class
   */
   ...
   * @param {module:com.ncloud.autoscaling.model/ScalingPolicy} obj Optional instance to populate.
   * @return {module:com.ncloud.autoscaling.model/ScalingPolicy} The populated <code>ScalingPolicy</code> instance.
   */
