...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Server.StopServerInstancesResponse = factory(root.Server.ApiClient, root.Server.ServerInstance);
  }
  ...
  /**
   * The StopServerInstancesResponse model module.
   * @module com.ncloud.server.model/StopServerInstancesResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>StopServerInstancesResponse</code>.
   * @alias module:com.ncloud.server.model/StopServerInstancesResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>StopServerInstancesResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:com.ncloud.server.model/StopServerInstancesResponse} obj Optional instance to populate.
   * @return {module:com.ncloud.server.model/StopServerInstancesResponse} The populated <code>StopServerInstancesResponse</code> instance.
   */
