...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Clouddb.DownloadDmsFileResponse = factory(root.Clouddb.ApiClient);
  }
  ...
  /**
   * The DownloadDmsFileResponse model module.
   * @module model/DownloadDmsFileResponse
   * @version 1.4.1
   */

  /**
   * Constructs a new <code>DownloadDmsFileResponse</code>.
   * @alias module:model/DownloadDmsFileResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>DownloadDmsFileResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DownloadDmsFileResponse} obj Optional instance to populate.
   * @return {module:model/DownloadDmsFileResponse} The populated <code>DownloadDmsFileResponse</code> instance.
   */
