...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Vserver.RemovePlacementGroupServerInstanceResponse = factory(root.Vserver.ApiClient, root.Vserver.ServerInstance);
  }
  ...
  /**
   * The RemovePlacementGroupServerInstanceResponse model module.
   * @module model/RemovePlacementGroupServerInstanceResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>RemovePlacementGroupServerInstanceResponse</code>.
   * @alias module:model/RemovePlacementGroupServerInstanceResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>RemovePlacementGroupServerInstanceResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RemovePlacementGroupServerInstanceResponse} obj Optional instance to populate.
   * @return {module:model/RemovePlacementGroupServerInstanceResponse} The populated <code>RemovePlacementGroupServerInstanceResponse</code> instance.
   */
