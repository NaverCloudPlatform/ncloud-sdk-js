...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Vserver.GetPublicIpTargetServerInstanceListResponse = factory(root.Vserver.ApiClient, root.Vserver.ServerInstance);
  }
   ...
   * @module model/GetPublicIpTargetServerInstanceListResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GetPublicIpTargetServerInstanceListResponse</code>.
   * @alias module:model/GetPublicIpTargetServerInstanceListResponse
   * @class
   */
   ...
   * @param {module:model/GetPublicIpTargetServerInstanceListResponse} obj Optional instance to populate.
   * @return {module:model/GetPublicIpTargetServerInstanceListResponse} The populated <code>GetPublicIpTargetServerInstanceListResponse</code> instance.
   */
