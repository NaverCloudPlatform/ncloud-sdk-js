...
(function(root, factory) {
   ...
   * @module com.ncloud.clouddb.model/GetCloudDBInstanceListRequest
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GetCloudDBInstanceListRequest</code>.
   * @alias module:com.ncloud.clouddb.model/GetCloudDBInstanceListRequest
   * @class
   ...
   * @param {module:com.ncloud.clouddb.model/GetCloudDBInstanceListRequest} obj Optional instance to populate.
   * @return {module:com.ncloud.clouddb.model/GetCloudDBInstanceListRequest} The populated <code>GetCloudDBInstanceListRequest</code> instance.
   */
