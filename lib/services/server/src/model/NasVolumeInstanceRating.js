...
(function(root, factory) {
   ...
   * @module model/NasVolumeInstanceRating
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>NasVolumeInstanceRating</code>.
   * @alias module:model/NasVolumeInstanceRating
   * @class
   */
   ...
   * @param {module:model/NasVolumeInstanceRating} obj Optional instance to populate.
   * @return {module:model/NasVolumeInstanceRating} The populated <code>NasVolumeInstanceRating</code> instance.
   */
