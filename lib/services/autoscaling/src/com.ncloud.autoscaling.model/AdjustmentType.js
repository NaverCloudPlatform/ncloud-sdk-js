...
(function(root, factory) {
   ...
   * @module com.ncloud.autoscaling.model/AdjustmentType
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>AdjustmentType</code>.
   * @alias module:com.ncloud.autoscaling.model/AdjustmentType
   * @class
   */
   ...
   * @param {module:com.ncloud.autoscaling.model/AdjustmentType} obj Optional instance to populate.
   * @return {module:com.ncloud.autoscaling.model/AdjustmentType} The populated <code>AdjustmentType</code> instance.
   */
  ...
  /**
   * @member {module:com.ncloud.autoscaling.model/CommonCode} adjustmentType
   */
