...
(function(root, factory) {
   ...
   * @module com.ncloud.loadbalancer.model/AccessControlGroup
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>AccessControlGroup</code>.
   * @alias module:com.ncloud.loadbalancer.model/AccessControlGroup
   * @class
   */
   ...
   * @param {module:com.ncloud.loadbalancer.model/AccessControlGroup} obj Optional instance to populate.
   * @return {module:com.ncloud.loadbalancer.model/AccessControlGroup} The populated <code>AccessControlGroup</code> instance.
   */
