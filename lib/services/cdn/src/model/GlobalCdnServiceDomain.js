...
(function(root, factory) {
   ...
   * @module model/GlobalCdnServiceDomain
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GlobalCdnServiceDomain</code>.
   * @alias module:model/GlobalCdnServiceDomain
   * @class
   */
   ...
   * @param {module:model/GlobalCdnServiceDomain} obj Optional instance to populate.
   * @return {module:model/GlobalCdnServiceDomain} The populated <code>GlobalCdnServiceDomain</code> instance.
   */
