...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Vserver.CreateNetworkInterfaceResponse = factory(root.Vserver.ApiClient, root.Vserver.NetworkInterface);
  }
  ...
  /**
   * The CreateNetworkInterfaceResponse model module.
   * @module model/CreateNetworkInterfaceResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>CreateNetworkInterfaceResponse</code>.
   * @alias module:model/CreateNetworkInterfaceResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>CreateNetworkInterfaceResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateNetworkInterfaceResponse} obj Optional instance to populate.
   * @return {module:model/CreateNetworkInterfaceResponse} The populated <code>CreateNetworkInterfaceResponse</code> instance.
   */
