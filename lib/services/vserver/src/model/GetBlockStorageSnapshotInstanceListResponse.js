...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Vserver.GetBlockStorageSnapshotInstanceListResponse = factory(root.Vserver.ApiClient, root.Vserver.BlockStorageSnapshotInstance);
  }
   ...
   * @module model/GetBlockStorageSnapshotInstanceListResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>GetBlockStorageSnapshotInstanceListResponse</code>.
   * @alias module:model/GetBlockStorageSnapshotInstanceListResponse
   * @class
   */
   ...
   * @param {module:model/GetBlockStorageSnapshotInstanceListResponse} obj Optional instance to populate.
   * @return {module:model/GetBlockStorageSnapshotInstanceListResponse} The populated <code>GetBlockStorageSnapshotInstanceListResponse</code> instance.
   */
