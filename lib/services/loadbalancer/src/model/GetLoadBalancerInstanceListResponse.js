...
(function(root, factory) {
   ...
   * @module model/GetLoadBalancerInstanceListResponse
   * @version 1.4.1
   */

  /**
   * Constructs a new <code>GetLoadBalancerInstanceListResponse</code>.
   * @alias module:model/GetLoadBalancerInstanceListResponse
   * @class
   */
   ...
   * @param {module:model/GetLoadBalancerInstanceListResponse} obj Optional instance to populate.
   * @return {module:model/GetLoadBalancerInstanceListResponse} The populated <code>GetLoadBalancerInstanceListResponse</code> instance.
   */
