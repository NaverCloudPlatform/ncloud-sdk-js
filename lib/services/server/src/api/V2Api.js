...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
    ...
    /**
     * 초기화스크립트리스트조회
     * @param {module:model/GetInitScriptListRequest} getInitScriptListRqeust getInitScriptListRqeust
     ...
     */
    this.getInitScriptList = function(getInitScriptListRqeust, callback) {
      var postBody = getInitScriptListRqeust;

      // verify the required parameter 'getInitScriptListRqeust' is set
      if (getInitScriptListRqeust === undefined || getInitScriptListRqeust === null) {
        throw new Error("Missing the required parameter 'getInitScriptListRqeust' when calling getInitScriptList");
      }
    ...
    /**
     * Callback function to receive the result of the replaceServerInstanceAssociatedWithPublicIp operation.
     * @callback module:api/V2Api~replaceServerInstanceAssociatedWithPublicIpCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ReplaceServerInstanceAssociatedWithPublicIpResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * 공인IP서버인스턴스교체
     * @param {module:model/ReplaceServerInstanceAssociatedWithPublicIpRequest} replaceServerInstanceAssociatedWithPublicIpRequest replaceServerInstanceAssociatedWithPublicIpRequest
     * @param {module:api/V2Api~replaceServerInstanceAssociatedWithPublicIpCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ReplaceServerInstanceAssociatedWithPublicIpResponse}
     */
    this.replaceServerInstanceAssociatedWithPublicIp = function(replaceServerInstanceAssociatedWithPublicIpRequest, callback) {
      var postBody = replaceServerInstanceAssociatedWithPublicIpRequest;

      // verify the required parameter 'replaceServerInstanceAssociatedWithPublicIpRequest' is set
      if (replaceServerInstanceAssociatedWithPublicIpRequest === undefined || replaceServerInstanceAssociatedWithPublicIpRequest === null) {
        throw new Error("Missing the required parameter 'replaceServerInstanceAssociatedWithPublicIpRequest' when calling replaceServerInstanceAssociatedWithPublicIp");
      }
      ...
      var contentTypes = ['application/x-www-form-urlencoded'];
      var accepts = [];
      var returnType = ReplaceServerInstanceAssociatedWithPublicIpResponse;

      return this.apiClient.callApi(
        '/replaceServerInstanceAssociatedWithPublicIp', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
