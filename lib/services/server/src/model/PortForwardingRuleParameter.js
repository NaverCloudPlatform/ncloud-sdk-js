...
(function(root, factory) {
   ...
   * @module model/PortForwardingRuleParameter
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PortForwardingRuleParameter</code>.
   * @alias module:model/PortForwardingRuleParameter
   * @class
   ...
   * @param {module:model/PortForwardingRuleParameter} obj Optional instance to populate.
   * @return {module:model/PortForwardingRuleParameter} The populated <code>PortForwardingRuleParameter</code> instance.
   */
