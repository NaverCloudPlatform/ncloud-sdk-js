...
(function(root, factory) {
   ...
   * @module com.ncloud.autoscaling.model/LoadBalancerInstanceSummary
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>LoadBalancerInstanceSummary</code>.
   * @alias module:com.ncloud.autoscaling.model/LoadBalancerInstanceSummary
   * @class
   */
   ...
   * @param {module:com.ncloud.autoscaling.model/LoadBalancerInstanceSummary} obj Optional instance to populate.
   * @return {module:com.ncloud.autoscaling.model/LoadBalancerInstanceSummary} The populated <code>LoadBalancerInstanceSummary</code> instance.
   */
