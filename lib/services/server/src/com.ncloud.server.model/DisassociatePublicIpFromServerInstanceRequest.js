...
(function(root, factory) {
   ...
   * @module com.ncloud.server.model/DisassociatePublicIpFromServerInstanceRequest
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DisassociatePublicIpFromServerInstanceRequest</code>.
   * @alias module:com.ncloud.server.model/DisassociatePublicIpFromServerInstanceRequest
   * @class
   ...
   * @param {module:com.ncloud.server.model/DisassociatePublicIpFromServerInstanceRequest} obj Optional instance to populate.
   * @return {module:com.ncloud.server.model/DisassociatePublicIpFromServerInstanceRequest} The populated <code>DisassociatePublicIpFromServerInstanceRequest</code> instance.
   */
