...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'com.ncloud.loadbalancer.model/CommonCode', 'com.ncloud.loadbalancer.model/LoadBalancedServerInstance', 'com.ncloud.loadbalancer.model/LoadBalancerRule'], factory);
   ...
   * @module com.ncloud.loadbalancer.model/LoadBalancerInstance
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>LoadBalancerInstance</code>.
   * @alias module:com.ncloud.loadbalancer.model/LoadBalancerInstance
   * @class
   */
   ...
   * @param {module:com.ncloud.loadbalancer.model/LoadBalancerInstance} obj Optional instance to populate.
   * @return {module:com.ncloud.loadbalancer.model/LoadBalancerInstance} The populated <code>LoadBalancerInstance</code> instance.
   */
  ...
  /**
   * 로드밸런서알고리즘구분코
   * @member {module:com.ncloud.loadbalancer.model/CommonCode} loadBalancerAlgorithmType
   */
  ...
  /**
   * 로드밸런서인스턴스상태
   * @member {module:com.ncloud.loadbalancer.model/CommonCode} loadBalancerInstanceStatus
   */
  exports.prototype['loadBalancerInstanceStatus'] = undefined;
  /**
   * 로드밸런서인스턴스OP
   * @member {module:com.ncloud.loadbalancer.model/CommonCode} loadBalancerInstanceOperation
   */
  exports.prototype['loadBalancerInstanceOperation'] = undefined;
  /**
   * 네트워크사용구분
   * @member {module:com.ncloud.loadbalancer.model/CommonCode} networkUsageType
   */
  ...
  /**
   * @member {Array.<module:com.ncloud.loadbalancer.model/LoadBalancerRule>} loadBalancerRuleList
   */
  exports.prototype['loadBalancerRuleList'] = undefined;
  /**
   * @member {Array.<module:com.ncloud.loadbalancer.model/LoadBalancedServerInstance>} loadBalancedServerInstanceList
   */
