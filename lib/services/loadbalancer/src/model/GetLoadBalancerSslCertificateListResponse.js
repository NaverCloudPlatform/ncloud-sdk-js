...
(function(root, factory) {
   ...
   * @module model/GetLoadBalancerSslCertificateListResponse
   * @version 1.4.1
   */

  /**
   * Constructs a new <code>GetLoadBalancerSslCertificateListResponse</code>.
   * @alias module:model/GetLoadBalancerSslCertificateListResponse
   * @class
   */
   ...
   * @param {module:model/GetLoadBalancerSslCertificateListResponse} obj Optional instance to populate.
   * @return {module:model/GetLoadBalancerSslCertificateListResponse} The populated <code>GetLoadBalancerSslCertificateListResponse</code> instance.
   */
