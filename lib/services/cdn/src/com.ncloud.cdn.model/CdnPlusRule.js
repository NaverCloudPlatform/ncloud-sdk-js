...
(function(root, factory) {
   ...
   * @module com.ncloud.cdn.model/CdnPlusRule
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CdnPlusRule</code>.
   * @alias module:com.ncloud.cdn.model/CdnPlusRule
   * @class
   */
   ...
   * @param {module:com.ncloud.cdn.model/CdnPlusRule} obj Optional instance to populate.
   * @return {module:com.ncloud.cdn.model/CdnPlusRule} The populated <code>CdnPlusRule</code> instance.
   */
