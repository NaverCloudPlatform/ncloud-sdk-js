...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Server.RebootServerInstancesResponse = factory(root.Server.ApiClient, root.Server.ServerInstance);
  }
  ...
  /**
   * The RebootServerInstancesResponse model module.
   * @module com.ncloud.server.model/RebootServerInstancesResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>RebootServerInstancesResponse</code>.
   * @alias module:com.ncloud.server.model/RebootServerInstancesResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>RebootServerInstancesResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:com.ncloud.server.model/RebootServerInstancesResponse} obj Optional instance to populate.
   * @return {module:com.ncloud.server.model/RebootServerInstancesResponse} The populated <code>RebootServerInstancesResponse</code> instance.
   */
