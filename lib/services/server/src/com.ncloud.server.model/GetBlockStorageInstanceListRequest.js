...
(function(root, factory) {
   ...
   * @module com.ncloud.server.model/GetBlockStorageInstanceListRequest
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GetBlockStorageInstanceListRequest</code>.
   * @alias module:com.ncloud.server.model/GetBlockStorageInstanceListRequest
   * @class
   */
   ...
   * @param {module:com.ncloud.server.model/GetBlockStorageInstanceListRequest} obj Optional instance to populate.
   * @return {module:com.ncloud.server.model/GetBlockStorageInstanceListRequest} The populated <code>GetBlockStorageInstanceListRequest</code> instance.
   */
