...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Vserver.AddPlacementGroupServerInstanceResponse = factory(root.Vserver.ApiClient, root.Vserver.ServerInstance);
  }
  ...
  /**
   * The AddPlacementGroupServerInstanceResponse model module.
   * @module model/AddPlacementGroupServerInstanceResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>AddPlacementGroupServerInstanceResponse</code>.
   * @alias module:model/AddPlacementGroupServerInstanceResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>AddPlacementGroupServerInstanceResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AddPlacementGroupServerInstanceResponse} obj Optional instance to populate.
   * @return {module:model/AddPlacementGroupServerInstanceResponse} The populated <code>AddPlacementGroupServerInstanceResponse</code> instance.
   */
