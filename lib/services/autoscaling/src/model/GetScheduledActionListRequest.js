...
(function(root, factory) {
   ...
   * @module model/GetScheduledActionListRequest
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GetScheduledActionListRequest</code>.
   * @alias module:model/GetScheduledActionListRequest
   * @class
   */
   ...
   * @param {module:model/GetScheduledActionListRequest} obj Optional instance to populate.
   * @return {module:model/GetScheduledActionListRequest} The populated <code>GetScheduledActionListRequest</code> instance.
   */
