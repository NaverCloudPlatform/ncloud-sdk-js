...
(function(root, factory) {
   ...
   * @module com.ncloud.loadbalancer.model/CreateLoadBalancerInstanceRequest
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CreateLoadBalancerInstanceRequest</code>.
   * @alias module:com.ncloud.loadbalancer.model/CreateLoadBalancerInstanceRequest
   * @class
   * @param loadBalancerRuleList {Array.<module:com.ncloud.loadbalancer.model/LoadBalancerRuleParameter>} 로드밸런서RULE리스트
   */
   ...
   * @param {module:com.ncloud.loadbalancer.model/CreateLoadBalancerInstanceRequest} obj Optional instance to populate.
   * @return {module:com.ncloud.loadbalancer.model/CreateLoadBalancerInstanceRequest} The populated <code>CreateLoadBalancerInstanceRequest</code> instance.
   */
