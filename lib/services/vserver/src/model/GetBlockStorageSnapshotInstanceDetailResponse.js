...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Vserver.GetBlockStorageSnapshotInstanceDetailResponse = factory(root.Vserver.ApiClient, root.Vserver.BlockStorageSnapshotInstance);
  }
  ...
  /**
   * The GetBlockStorageSnapshotInstanceDetailResponse model module.
   * @module model/GetBlockStorageSnapshotInstanceDetailResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GetBlockStorageSnapshotInstanceDetailResponse</code>.
   * @alias module:model/GetBlockStorageSnapshotInstanceDetailResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>GetBlockStorageSnapshotInstanceDetailResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetBlockStorageSnapshotInstanceDetailResponse} obj Optional instance to populate.
   * @return {module:model/GetBlockStorageSnapshotInstanceDetailResponse} The populated <code>GetBlockStorageSnapshotInstanceDetailResponse</code> instance.
   */
