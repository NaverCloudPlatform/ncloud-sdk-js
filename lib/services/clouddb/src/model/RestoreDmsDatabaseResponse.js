...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Clouddb.RestoreDmsDatabaseResponse = factory(root.Clouddb.ApiClient);
  }
  ...
  /**
   * The RestoreDmsDatabaseResponse model module.
   * @module model/RestoreDmsDatabaseResponse
   * @version 1.4.1
   */

  /**
   * Constructs a new <code>RestoreDmsDatabaseResponse</code>.
   * @alias module:model/RestoreDmsDatabaseResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>RestoreDmsDatabaseResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RestoreDmsDatabaseResponse} obj Optional instance to populate.
   * @return {module:model/RestoreDmsDatabaseResponse} The populated <code>RestoreDmsDatabaseResponse</code> instance.
   */
