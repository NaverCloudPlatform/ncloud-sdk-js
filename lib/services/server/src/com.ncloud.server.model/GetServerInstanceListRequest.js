...
(function(root, factory) {
   ...
   * @module com.ncloud.server.model/GetServerInstanceListRequest
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GetServerInstanceListRequest</code>.
   * @alias module:com.ncloud.server.model/GetServerInstanceListRequest
   * @class
   */
   ...
   * @param {module:com.ncloud.server.model/GetServerInstanceListRequest} obj Optional instance to populate.
   * @return {module:com.ncloud.server.model/GetServerInstanceListRequest} The populated <code>GetServerInstanceListRequest</code> instance.
   */
