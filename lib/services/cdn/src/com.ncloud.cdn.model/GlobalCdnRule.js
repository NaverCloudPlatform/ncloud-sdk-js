...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Cdn.GlobalCdnRule = factory(root.Cdn.ApiClient);
  }
  ...
  /**
   * The GlobalCdnRule model module.
   * @module com.ncloud.cdn.model/GlobalCdnRule
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GlobalCdnRule</code>.
   * @alias module:com.ncloud.cdn.model/GlobalCdnRule
   * @class
   */
  ...
  /**
   * Constructs a <code>GlobalCdnRule</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:com.ncloud.cdn.model/GlobalCdnRule} obj Optional instance to populate.
   * @return {module:com.ncloud.cdn.model/GlobalCdnRule} The populated <code>GlobalCdnRule</code> instance.
   */
