...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'com.ncloud.autoscaling.model/AccessControlGroup'], factory);
   ...
   * @module com.ncloud.autoscaling.model/LaunchConfiguration
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>LaunchConfiguration</code>.
   * @alias module:com.ncloud.autoscaling.model/LaunchConfiguration
   * @class
   */
   ...
   * @param {module:com.ncloud.autoscaling.model/LaunchConfiguration} obj Optional instance to populate.
   * @return {module:com.ncloud.autoscaling.model/LaunchConfiguration} The populated <code>LaunchConfiguration</code> instance.
   */
  ...
  /**
   * ACG리스트
   * @member {Array.<module:com.ncloud.autoscaling.model/AccessControlGroup>} accessControlGroupList
   */
