...
(function(root, factory) {
   ...
   * @module com.ncloud.loadbalancer.model/Region
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>Region</code>.
   * @alias module:com.ncloud.loadbalancer.model/Region
   * @class
   */
   ...
   * @param {module:com.ncloud.loadbalancer.model/Region} obj Optional instance to populate.
   * @return {module:com.ncloud.loadbalancer.model/Region} The populated <code>Region</code> instance.
   */
