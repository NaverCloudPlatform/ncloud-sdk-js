...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Vserver.GetServerInstanceDetailResponse = factory(root.Vserver.ApiClient, root.Vserver.ServerInstance);
  }
  ...
  /**
   * The GetServerInstanceDetailResponse model module.
   * @module model/GetServerInstanceDetailResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GetServerInstanceDetailResponse</code>.
   * @alias module:model/GetServerInstanceDetailResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>GetServerInstanceDetailResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetServerInstanceDetailResponse} obj Optional instance to populate.
   * @return {module:model/GetServerInstanceDetailResponse} The populated <code>GetServerInstanceDetailResponse</code> instance.
   */
