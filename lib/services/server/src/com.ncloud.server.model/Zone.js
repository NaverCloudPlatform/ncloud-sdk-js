...
(function(root, factory) {
   ...
   * @module com.ncloud.server.model/Zone
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>Zone</code>.
   * @alias module:com.ncloud.server.model/Zone
   * @class
   */
   ...
   * @param {module:com.ncloud.server.model/Zone} obj Optional instance to populate.
   * @return {module:com.ncloud.server.model/Zone} The populated <code>Zone</code> instance.
   */
