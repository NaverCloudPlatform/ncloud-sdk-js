...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Vserver.DeleteNetworkInterfaceResponse = factory(root.Vserver.ApiClient, root.Vserver.NetworkInterface);
  }
  ...
  /**
   * The DeleteNetworkInterfaceResponse model module.
   * @module model/DeleteNetworkInterfaceResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>DeleteNetworkInterfaceResponse</code>.
   * @alias module:model/DeleteNetworkInterfaceResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>DeleteNetworkInterfaceResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DeleteNetworkInterfaceResponse} obj Optional instance to populate.
   * @return {module:model/DeleteNetworkInterfaceResponse} The populated <code>DeleteNetworkInterfaceResponse</code> instance.
   */
