...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Vserver.StartServerInstancesResponse = factory(root.Vserver.ApiClient, root.Vserver.ServerInstance);
  }
   ...
   * @module model/StartServerInstancesResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>StartServerInstancesResponse</code>.
   * @alias module:model/StartServerInstancesResponse
   * @class
   */
   ...
   * @param {module:model/StartServerInstancesResponse} obj Optional instance to populate.
   * @return {module:model/StartServerInstancesResponse} The populated <code>StartServerInstancesResponse</code> instance.
   */
