...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Server.RecreateServerInstanceResponse = factory(root.Server.ApiClient, root.Server.ServerInstance);
  }
  ...
  /**
   * The RecreateServerInstanceResponse model module.
   * @module com.ncloud.server.model/RecreateServerInstanceResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>RecreateServerInstanceResponse</code>.
   * @alias module:com.ncloud.server.model/RecreateServerInstanceResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>RecreateServerInstanceResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:com.ncloud.server.model/RecreateServerInstanceResponse} obj Optional instance to populate.
   * @return {module:com.ncloud.server.model/RecreateServerInstanceResponse} The populated <code>RecreateServerInstanceResponse</code> instance.
   */
