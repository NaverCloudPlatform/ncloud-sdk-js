...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Vserver.GetInitScriptListResponse = factory(root.Vserver.ApiClient, root.Vserver.InitScript);
  }
  ...
  /**
   * The GetInitScriptListResponse model module.
   * @module model/GetInitScriptListResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GetInitScriptListResponse</code>.
   * @alias module:model/GetInitScriptListResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>GetInitScriptListResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetInitScriptListResponse} obj Optional instance to populate.
   * @return {module:model/GetInitScriptListResponse} The populated <code>GetInitScriptListResponse</code> instance.
   */
