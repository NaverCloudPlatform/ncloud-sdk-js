...
(function(root, factory) {
   ...
   * @module model/GetLoadBalancerTargetServerInstanceListResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GetLoadBalancerTargetServerInstanceListResponse</code>.
   * @alias module:model/GetLoadBalancerTargetServerInstanceListResponse
   * @class
   */
   ...
   * @param {module:model/GetLoadBalancerTargetServerInstanceListResponse} obj Optional instance to populate.
   * @return {module:model/GetLoadBalancerTargetServerInstanceListResponse} The populated <code>GetLoadBalancerTargetServerInstanceListResponse</code> instance.
   */
