...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Vserver.AttachNetworkInterfaceResponse = factory(root.Vserver.ApiClient, root.Vserver.NetworkInterface);
  }
  ...
  /**
   * The AttachNetworkInterfaceResponse model module.
   * @module model/AttachNetworkInterfaceResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>AttachNetworkInterfaceResponse</code>.
   * @alias module:model/AttachNetworkInterfaceResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>AttachNetworkInterfaceResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AttachNetworkInterfaceResponse} obj Optional instance to populate.
   * @return {module:model/AttachNetworkInterfaceResponse} The populated <code>AttachNetworkInterfaceResponse</code> instance.
   */
