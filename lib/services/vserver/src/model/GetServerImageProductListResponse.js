...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Vserver.GetServerImageProductListResponse = factory(root.Vserver.ApiClient, root.Vserver.Product);
  }
   ...
   * @module model/GetServerImageProductListResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>GetServerImageProductListResponse</code>.
   * @alias module:model/GetServerImageProductListResponse
   * @class
   */
   ...
   * @param {module:model/GetServerImageProductListResponse} obj Optional instance to populate.
   * @return {module:model/GetServerImageProductListResponse} The populated <code>GetServerImageProductListResponse</code> instance.
   */
