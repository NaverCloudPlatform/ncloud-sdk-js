...
(function(root, factory) {
   ...
   * @module com.ncloud.loadbalancer.model/DeleteLoadBalancerSslCertificateResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DeleteLoadBalancerSslCertificateResponse</code>.
   * @alias module:com.ncloud.loadbalancer.model/DeleteLoadBalancerSslCertificateResponse
   * @class
   */
   ...
   * @param {module:com.ncloud.loadbalancer.model/DeleteLoadBalancerSslCertificateResponse} obj Optional instance to populate.
   * @return {module:com.ncloud.loadbalancer.model/DeleteLoadBalancerSslCertificateResponse} The populated <code>DeleteLoadBalancerSslCertificateResponse</code> instance.
   */
