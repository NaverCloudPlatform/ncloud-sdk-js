...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Clouddb.Region = factory(root.Clouddb.ApiClient);
  }
   ...
   * @module com.ncloud.clouddb.model/Region
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>Region</code>.
   * @alias module:com.ncloud.clouddb.model/Region
   * @class
   */
   ...
   * @param {module:com.ncloud.clouddb.model/Region} obj Optional instance to populate.
   * @return {module:com.ncloud.clouddb.model/Region} The populated <code>Region</code> instance.
   */
