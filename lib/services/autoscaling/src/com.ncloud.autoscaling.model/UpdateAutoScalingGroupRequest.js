...
(function(root, factory) {
   ...
   * @module com.ncloud.autoscaling.model/UpdateAutoScalingGroupRequest
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>UpdateAutoScalingGroupRequest</code>.
   * @alias module:com.ncloud.autoscaling.model/UpdateAutoScalingGroupRequest
   * @class
   ...
   * @param {module:com.ncloud.autoscaling.model/UpdateAutoScalingGroupRequest} obj Optional instance to populate.
   * @return {module:com.ncloud.autoscaling.model/UpdateAutoScalingGroupRequest} The populated <code>UpdateAutoScalingGroupRequest</code> instance.
   */
