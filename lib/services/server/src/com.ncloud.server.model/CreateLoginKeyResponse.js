...
(function(root, factory) {
   ...
   * @module com.ncloud.server.model/CreateLoginKeyResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CreateLoginKeyResponse</code>.
   * @alias module:com.ncloud.server.model/CreateLoginKeyResponse
   * @class
   */
   ...
   * @param {module:com.ncloud.server.model/CreateLoginKeyResponse} obj Optional instance to populate.
   * @return {module:com.ncloud.server.model/CreateLoginKeyResponse} The populated <code>CreateLoginKeyResponse</code> instance.
   */
