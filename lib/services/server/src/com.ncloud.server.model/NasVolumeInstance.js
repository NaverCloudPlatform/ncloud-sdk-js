...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'com.ncloud.server.model/CommonCode', 'com.ncloud.server.model/NasVolumeInstanceCustomIp', 'com.ncloud.server.model/NasVolumeServerInstance', 'com.ncloud.server.model/Region', 'com.ncloud.server.model/Zone'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CommonCode'), require('./NasVolumeInstanceCustomIp'), require('./NasVolumeServerInstance'), require('./Region'), require('./Zone'));
  } else {
    // Browser globals (root is window)
    if (!root.Server) {
      root.Server = {};
    }
    root.Server.NasVolumeInstance = factory(root.Server.ApiClient, root.Server.CommonCode, root.Server.NasVolumeInstanceCustomIp, root.Server.NasVolumeServerInstance, root.Server.Region, root.Server.Zone);
  }
}(this, function(ApiClient, CommonCode, NasVolumeInstanceCustomIp, NasVolumeServerInstance, Region, Zone) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('nasVolumeServerInstanceList')) {
        obj['nasVolumeServerInstanceList'] = ApiClient.convertToType(data['nasVolumeServerInstanceList'], [NasVolumeServerInstance]);
      }
    }
    return obj;
  }
  ...
  /**
   * NAS볼륨서버인스턴스리스트
   * @member {Array.<module:com.ncloud.server.model/NasVolumeServerInstance>} nasVolumeServerInstanceList
   */
