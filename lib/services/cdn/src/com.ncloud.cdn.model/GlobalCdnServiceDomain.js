...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Cdn.GlobalCdnServiceDomain = factory(root.Cdn.ApiClient);
  }
  ...
  /**
   * The GlobalCdnServiceDomain model module.
   * @module com.ncloud.cdn.model/GlobalCdnServiceDomain
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GlobalCdnServiceDomain</code>.
   * @alias module:com.ncloud.cdn.model/GlobalCdnServiceDomain
   * @class
   */
  ...
  /**
   * Constructs a <code>GlobalCdnServiceDomain</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:com.ncloud.cdn.model/GlobalCdnServiceDomain} obj Optional instance to populate.
   * @return {module:com.ncloud.cdn.model/GlobalCdnServiceDomain} The populated <code>GlobalCdnServiceDomain</code> instance.
   */
