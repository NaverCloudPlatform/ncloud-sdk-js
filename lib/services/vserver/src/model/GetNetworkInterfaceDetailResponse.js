...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Vserver.GetNetworkInterfaceDetailResponse = factory(root.Vserver.ApiClient, root.Vserver.NetworkInterface);
  }
  ...
  /**
   * The GetNetworkInterfaceDetailResponse model module.
   * @module model/GetNetworkInterfaceDetailResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>GetNetworkInterfaceDetailResponse</code>.
   * @alias module:model/GetNetworkInterfaceDetailResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>GetNetworkInterfaceDetailResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetNetworkInterfaceDetailResponse} obj Optional instance to populate.
   * @return {module:model/GetNetworkInterfaceDetailResponse} The populated <code>GetNetworkInterfaceDetailResponse</code> instance.
   */
