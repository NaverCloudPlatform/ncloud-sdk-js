...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Vpc.GetVpcPeeringInstanceDetailResponse = factory(root.Vpc.ApiClient, root.Vpc.VpcPeeringInstance);
  }
  ...
  /**
   * The GetVpcPeeringInstanceDetailResponse model module.
   * @module model/GetVpcPeeringInstanceDetailResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>GetVpcPeeringInstanceDetailResponse</code>.
   * @alias module:model/GetVpcPeeringInstanceDetailResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>GetVpcPeeringInstanceDetailResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetVpcPeeringInstanceDetailResponse} obj Optional instance to populate.
   * @return {module:model/GetVpcPeeringInstanceDetailResponse} The populated <code>GetVpcPeeringInstanceDetailResponse</code> instance.
   */
