...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Vserver.GetNetworkInterfaceListResponse = factory(root.Vserver.ApiClient, root.Vserver.NetworkInterface);
  }
  ...
  /**
   * The GetNetworkInterfaceListResponse model module.
   * @module model/GetNetworkInterfaceListResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GetNetworkInterfaceListResponse</code>.
   * @alias module:model/GetNetworkInterfaceListResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>GetNetworkInterfaceListResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetNetworkInterfaceListResponse} obj Optional instance to populate.
   * @return {module:model/GetNetworkInterfaceListResponse} The populated <code>GetNetworkInterfaceListResponse</code> instance.
   */
