...
(function(root, factory) {
   ...
   * @module model/GlobalCdnRule
   * @version 1.4.1
   */

  /**
   * Constructs a new <code>GlobalCdnRule</code>.
   * @alias module:model/GlobalCdnRule
   * @class
   */
   ...
   * @param {module:model/GlobalCdnRule} obj Optional instance to populate.
   * @return {module:model/GlobalCdnRule} The populated <code>GlobalCdnRule</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('cachingTtlTime')) {
        obj['cachingTtlTime'] = ApiClient.convertToType(data['cachingTtlTime'], 'Number');
      }
