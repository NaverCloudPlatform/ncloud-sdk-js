...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Vserver.CreateServerInstancesResponse = factory(root.Vserver.ApiClient, root.Vserver.ServerInstance);
  }
   ...
   * @module model/CreateServerInstancesResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CreateServerInstancesResponse</code>.
   * @alias module:model/CreateServerInstancesResponse
   * @class
   */
   ...
   * @param {module:model/CreateServerInstancesResponse} obj Optional instance to populate.
   * @return {module:model/CreateServerInstancesResponse} The populated <code>CreateServerInstancesResponse</code> instance.
   */
