...
(function(root, factory) {
   ...
   * @module com.ncloud.server.model/MemberServerImage
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>MemberServerImage</code>.
   * @alias module:com.ncloud.server.model/MemberServerImage
   * @class
   */
   ...
   * @param {module:com.ncloud.server.model/MemberServerImage} obj Optional instance to populate.
   * @return {module:com.ncloud.server.model/MemberServerImage} The populated <code>MemberServerImage</code> instance.
   */
  ...
  /**
   * 원본서버기본블록스토리지디스크유형
   * @member {module:com.ncloud.server.model/CommonCode} originalBaseBlockStorageDiskType
   */
  ...
  /**
   * 원본서버이미지상태
   * @member {module:com.ncloud.server.model/CommonCode} memberServerImageStatus
   */
  exports.prototype['memberServerImageStatus'] = undefined;
  /**
   * 원본서버이미지OP
   * @member {module:com.ncloud.server.model/CommonCode} memberServerImageOperation
   */
  exports.prototype['memberServerImageOperation'] = undefined;
  /**
   * 회원서버이미지플랫폼구분
   * @member {module:com.ncloud.server.model/CommonCode} memberServerImagePlatformType
   */
