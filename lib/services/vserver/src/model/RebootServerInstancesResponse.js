...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Vserver.RebootServerInstancesResponse = factory(root.Vserver.ApiClient, root.Vserver.ServerInstance);
  }
   ...
   * @module model/RebootServerInstancesResponse
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>RebootServerInstancesResponse</code>.
   * @alias module:model/RebootServerInstancesResponse
   * @class
   */
   ...
   * @param {module:model/RebootServerInstancesResponse} obj Optional instance to populate.
   * @return {module:model/RebootServerInstancesResponse} The populated <code>RebootServerInstancesResponse</code> instance.
   */
