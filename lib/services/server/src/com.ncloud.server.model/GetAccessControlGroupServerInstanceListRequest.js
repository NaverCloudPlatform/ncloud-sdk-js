...
(function(root, factory) {
   ...
   * @module com.ncloud.server.model/GetAccessControlGroupServerInstanceListRequest
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GetAccessControlGroupServerInstanceListRequest</code>.
   * @alias module:com.ncloud.server.model/GetAccessControlGroupServerInstanceListRequest
   * @class
   ...
   * @param {module:com.ncloud.server.model/GetAccessControlGroupServerInstanceListRequest} obj Optional instance to populate.
   * @return {module:com.ncloud.server.model/GetAccessControlGroupServerInstanceListRequest} The populated <code>GetAccessControlGroupServerInstanceListRequest</code> instance.
   */
