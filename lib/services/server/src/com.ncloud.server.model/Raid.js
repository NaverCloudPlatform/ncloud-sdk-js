...
(function(root, factory) {
   ...
   * @module com.ncloud.server.model/Raid
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>Raid</code>.
   * @alias module:com.ncloud.server.model/Raid
   * @class
   */
   ...
   * @param {module:com.ncloud.server.model/Raid} obj Optional instance to populate.
   * @return {module:com.ncloud.server.model/Raid} The populated <code>Raid</code> instance.
   */
