...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Server.GetPublicIpInstanceListRequest = factory(root.Server.ApiClient);
  }
   ...
   * @module com.ncloud.server.model/GetPublicIpInstanceListRequest
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GetPublicIpInstanceListRequest</code>.
   * @alias module:com.ncloud.server.model/GetPublicIpInstanceListRequest
   * @class
   */
   ...
   * @param {module:com.ncloud.server.model/GetPublicIpInstanceListRequest} obj Optional instance to populate.
   * @return {module:com.ncloud.server.model/GetPublicIpInstanceListRequest} The populated <code>GetPublicIpInstanceListRequest</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('publicIpList')) {
        obj['publicIpList'] = ApiClient.convertToType(data['publicIpList'], ['String']);
      }
  ...
  /**
   * 공인IP리스트
   * @member {Array.<String>} publicIpList
   */
  exports.prototype['publicIpList'] = undefined;
  /**
   * 검색할필터명
