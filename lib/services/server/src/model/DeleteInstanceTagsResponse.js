...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Server.DeleteInstanceTagsResponse = factory(root.Server.ApiClient);
  }
  ...
  /**
   * The DeleteInstanceTagsResponse model module.
   * @module model/DeleteInstanceTagsResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DeleteInstanceTagsResponse</code>.
   * @alias module:model/DeleteInstanceTagsResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>DeleteInstanceTagsResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DeleteInstanceTagsResponse} obj Optional instance to populate.
   * @return {module:model/DeleteInstanceTagsResponse} The populated <code>DeleteInstanceTagsResponse</code> instance.
   */
