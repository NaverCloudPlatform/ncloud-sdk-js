...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Server.AccessControlGroup = factory(root.Server.ApiClient);
  }
   ...
   * @module com.ncloud.server.model/AccessControlGroup
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>AccessControlGroup</code>.
   * @alias module:com.ncloud.server.model/AccessControlGroup
   * @class
   */
   ...
   * @param {module:com.ncloud.server.model/AccessControlGroup} obj Optional instance to populate.
   * @return {module:com.ncloud.server.model/AccessControlGroup} The populated <code>AccessControlGroup</code> instance.
   */
