...
(function(root, factory) {
   ...
   * @module model/GetLoadBalancedServerInstanceListResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GetLoadBalancedServerInstanceListResponse</code>.
   * @alias module:model/GetLoadBalancedServerInstanceListResponse
   * @class
   */
   ...
   * @param {module:model/GetLoadBalancedServerInstanceListResponse} obj Optional instance to populate.
   * @return {module:model/GetLoadBalancedServerInstanceListResponse} The populated <code>GetLoadBalancedServerInstanceListResponse</code> instance.
   */
