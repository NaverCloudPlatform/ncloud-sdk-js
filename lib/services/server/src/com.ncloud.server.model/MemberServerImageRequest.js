...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Server.MemberServerImageRequest = factory(root.Server.ApiClient);
  }
  ...
  /**
   * The MemberServerImageRequest model module.
   * @module com.ncloud.server.model/MemberServerImageRequest
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>MemberServerImageRequest</code>.
   * @alias module:com.ncloud.server.model/MemberServerImageRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>MemberServerImageRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:com.ncloud.server.model/MemberServerImageRequest} obj Optional instance to populate.
   * @return {module:com.ncloud.server.model/MemberServerImageRequest} The populated <code>MemberServerImageRequest</code> instance.
   */
