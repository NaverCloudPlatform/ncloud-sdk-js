...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'com.ncloud.clouddb.model/CloudDBConfigGroup'], factory);
   ...
   * @module com.ncloud.clouddb.model/GetCloudDBConfigGroupListResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GetCloudDBConfigGroupListResponse</code>.
   * @alias module:com.ncloud.clouddb.model/GetCloudDBConfigGroupListResponse
   * @class
   */
   ...
   * @param {module:com.ncloud.clouddb.model/GetCloudDBConfigGroupListResponse} obj Optional instance to populate.
   * @return {module:com.ncloud.clouddb.model/GetCloudDBConfigGroupListResponse} The populated <code>GetCloudDBConfigGroupListResponse</code> instance.
   */
