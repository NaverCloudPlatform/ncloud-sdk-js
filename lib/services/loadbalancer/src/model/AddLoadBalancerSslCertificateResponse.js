...
(function(root, factory) {
   ...
   * @module model/AddLoadBalancerSslCertificateResponse
   * @version 1.4.1
   */

  /**
   * Constructs a new <code>AddLoadBalancerSslCertificateResponse</code>.
   * @alias module:model/AddLoadBalancerSslCertificateResponse
   * @class
   */
   ...
   * @param {module:model/AddLoadBalancerSslCertificateResponse} obj Optional instance to populate.
   * @return {module:model/AddLoadBalancerSslCertificateResponse} The populated <code>AddLoadBalancerSslCertificateResponse</code> instance.
   */
