...
(function(root, factory) {
   ...
   * @module model/GetAccessControlGroupServerInstanceListResponse
   * @version 1.4.1
   */

  /**
   * Constructs a new <code>GetAccessControlGroupServerInstanceListResponse</code>.
   * @alias module:model/GetAccessControlGroupServerInstanceListResponse
   * @class
   */
   ...
   * @param {module:model/GetAccessControlGroupServerInstanceListResponse} obj Optional instance to populate.
   * @return {module:model/GetAccessControlGroupServerInstanceListResponse} The populated <code>GetAccessControlGroupServerInstanceListResponse</code> instance.
   */
